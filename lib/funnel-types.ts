...
const BASIC_CONTENT: BlockTypeConfig[] = [
  ...
  { type: 'paragraph',  label: 'Text',        description: 'Absatz',      category: 'Inhalt', defaultProps: DEFAULT_BLOCK_PROPS.paragraph },
  { type: 'image',      label: 'Bild',        description: 'Bild mit optionaler Bildunterschrift', category: 'Inhalt', defaultProps: DEFAULT_BLOCK_PROPS.image },
  { type: 'button',     label: 'Button',      description: 'Call-to-Action', category: 'Inhalt', defaultProps: DEFAULT_BLOCK_PROPS.button },
  { type: 'video',      label: 'Video',       description: 'Eingebettetes Video', category: 'Inhalt', defaultProps: DEFAULT_BLOCK_PROPS.video },
  { type: 'spacer',     label: 'Abstand',     description: 'Vertikaler Freiraum', category: 'Layout', defaultProps: DEFAULT_BLOCK_PROPS.spacer },
];

export const BLOCK_CATALOG: Record<FunnelContentType, BlockTypeConfig[]> = {
  quest: [
    { type: 'quest_scene',    label: 'Szene',       description: 'Bild + Titel + Beschreibung',     category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_scene },
    { type: 'quest_dialog',   label: 'Dialog',      description: 'Sprechblasen-Dialog',             category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_dialog },
    { type: 'quest_decision', label: 'Entscheidung',description: 'Verzweigung mit Optionen',        category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_decision },
    { type: 'quest_quiz',     label: 'Quiz',        description: 'Multiple-Choice-Frage',           category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_quiz },
    { type: 'quest_info',     label: 'Info',        description: 'Informationsblock',               category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_info },
    { type: 'quest_freetext', label: 'Freitext',    description: 'Freier Textbereich',              category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_freetext },
    { type: 'quest_file',     label: 'Datei',       description: 'Downloadbarer Anhang (PDF etc.)', category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_file },
    { type: 'quest_spinner',  label: 'Ladescreen',  description: 'Ladeanimation, geht automatisch weiter', category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_spinner },
    { type: 'quest_rating',   label: 'Bewertung',   description: 'Sterne oder Emoji-Bewertung',      category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_rating },
    { type: 'quest_vorname',  label: 'Vorname',     description: 'Namenseingabe – als {{name}} nutzbar', category: 'Quest', defaultProps: DEFAULT_BLOCK_PROPS.quest_vorname },
  ...
  check: [
    { type: 'check_intro',         label: 'Intro',            description: 'Einstiegsscreen',              category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_intro },
    { type: 'check_vorname',       label: 'Name',             description: 'Namenseingabe',                category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_vorname },
    { type: 'check_frage',         label: 'Frage',            description: 'Einzel- oder Slider-Frage',   category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_frage },
    { type: 'check_ergebnisfrage', label: 'Ergebnisfrage',    description: 'Frage mit Dimensions-Score',  category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_ergebnisfrage },
    { type: 'check_selbst',        label: 'Selbsteinschätzung', description: 'Slider-Einschätzung',       category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_selbst },
    { type: 'check_lead',          label: 'Kontaktformular',  description: 'Lead-Erfassung',              category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_lead },
    { type: 'check_ergebnis',      label: 'Ergebnis',         description: 'Ergebnisanzeige',             category: 'Berufscheck', defaultProps: DEFAULT_BLOCK_PROPS.check_ergebnis },
    ...BASIC_CONTENT,
  ],
  form: [
    { type: 'form_hero',    label: 'Hero',          description: 'Haupt-Banner mit CTA',           category: 'Formular', defaultProps: DEFAULT_BLOCK_PROPS.form_hero },
    { type: 'form_text',    label: 'Textabschnitt', description: 'Überschrift + Text',             category: 'Formular', defaultProps: DEFAULT_BLOCK_PROPS.form_text },
    { type: 'form_image',   label: 'Bild',          description: 'Vollbreites Bild',               category: 'Formular', defaultProps: DEFAULT_BLOCK_PROPS.form_image },
    { type: 'form_step',    label: 'Formular-Schritt', description: 'Eingabefelder',               category: 'Formular', defaultProps: DEFAULT_BLOCK_PROPS.form_step },
    { type: 'form_config',  label: 'Einstellungen', description: 'Danke-Seite & Datenschutz',      category: 'Formular', defaultProps: DEFAULT_BLOCK_PROPS.form_config },
    ...BASIC_CONTENT,
  ],
};
